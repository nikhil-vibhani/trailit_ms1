...
module.exports = function () {
    ...
    // console.log(`======================== DIRECT video and audio trail data tests ========================`);
    ...
    beforeEach(() => {
        ...
        trailitdata = {
            ...
            trail_id: '13',
            title: 'testing direct video trail data',
            description: '',
            type: 'video',
            media_type: 'video',
        ...
        trail_data_id = trail_data_id ? trail_data_id : '14';

        trailDataUpdate = {
            trail_data_id: trail_data_id ? trail_data_id : '14',
            updateValue: {
                title: '14th direct video trail data',
                description: ''
            },
